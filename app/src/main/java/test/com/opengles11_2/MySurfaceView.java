...
import static test.com.opengles11_2.MainActivity.HEIGHT;
import static test.com.opengles11_2.MainActivity.WIDTH;
...
public class MySurfaceView extends GLSurfaceView {
    ...
    static float cx = 50;//摄像机x坐标
    static float cy = 70;
    static float cz = 280;//摄像机z坐标
...
//
//        //设置新的摄像机坐标
//        cz = (float) (Math.cos(direction) * cz);
//        cx = (float) (cx + Math.cos(direction) * cx);
////        //设置新的观察目标点XZ坐标
////        tx = (float) (cx - Math.sin(direction) * Offset);//观察目标点x坐标
////        tz = (float) (cz - Math.cos(direction) * Offset);//观察目标点z坐标
//
...
//    }
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //初始化纹理
            mountionId = initTexture(R.mipmap.grass_01);
            rockId = initTexture(R.mipmap.rock_01);

            obstacle = new Obstacle(0.3f);
        }
    }
